...
import usecases.account.AddSemesterCourseUseCase;
...
public class SemesterTest {
    ...
    public void addSemesterCourseTest(){
        ...
        AddSemesterCourseUseCase myUseCase = new AddSemesterCourseUseCase(entityFactory, entityGateway);
        AddSemesterCourseRequest request = new AddSemesterCourseRequest("88888888", "AAA111", "test", 0.5F);
