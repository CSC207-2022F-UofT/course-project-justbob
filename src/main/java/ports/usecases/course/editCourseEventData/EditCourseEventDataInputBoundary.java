...
public interface EditCourseEventDataInputBoundary {
     ...
     * @throws ports.usecases.course.editCourseEventData.EditCourseEventDataInputBoundary.EditCourseEventDataError
     *          if the new title, day, startTime, endTime, or location is invalid
     */
